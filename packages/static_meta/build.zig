...
pub fn build(b: *std.Build) void {
    ...
    options.addOption([]const u8, "static_package", "static_meta");
    ...
    const tests = b.addTest(.{ .root_module = static_meta_mod });
    ...
    const examples = [_]struct { name: []const u8, path: []const u8 }{
        .{ .name = "static_meta_type_id_basic", .path = "examples/type_id_basic.zig" },
        .{ .name = "static_meta_type_registry_basic", .path = "examples/type_registry_basic.zig" },
    };
    for (examples) |ex| {
        const exe = b.addExecutable(.{
            ...
            .root_module = b.createModule(.{
                ...
                .optimize = optimize,
                .imports = &.{
                    .{ .name = "static_meta", .module = static_meta_mod },
                },
            }),
        });
