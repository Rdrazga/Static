...
pub fn build(b: *std.Build) void {
    ...
    options.addOption([]const u8, "static_package", "static_memory");
    ...
    const tests = b.addTest(.{ .root_module = static_memory_mod });
    ...
    const examples = [_]struct { name: []const u8, path: []const u8 }{
        .{
            .name = "static_memory_budget_lock_in",
            .path = "examples/budget_lock_in.zig",
        },
        .{
            .name = "static_memory_scratch_mark_rollback",
            .path = "examples/scratch_mark_rollback.zig",
        },
        .{
            .name = "static_memory_typed_pool_basic",
            .path = "examples/typed_pool_basic.zig",
        },
        .{
            .name = "static_memory_budget_lock_in_embedded",
            .path = "examples/budget_lock_in_embedded.zig",
        },
        .{
            .name = "static_memory_frame_arena_reset",
            .path = "examples/frame_arena_reset.zig",
        },
    };
    for (examples) |ex| {
