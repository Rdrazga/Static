...
pub fn writeGroupReport(
    ...
    var comparisons: [8]bench.baseline.BaselineCaseComparison = undefined;
    var history_existing_buffer: [16 * 1024]u8 = undefined;
    var history_record_buffer: [16 * 1024]u8 = undefined;
    var history_frame_buffer: [16 * 1024]u8 = undefined;
    var history_output_buffer: [16 * 1024]u8 = undefined;
    var history_file_buffer: [16 * 1024]u8 = undefined;
    var history_cases: [4]bench.stats.BenchmarkStats = undefined;
    var history_names: [1024]u8 = undefined;
    var history_tags: [4][]const u8 = undefined;
    var history_comparisons: [8]bench.baseline.BaselineCaseComparison = undefined;
