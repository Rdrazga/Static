...
pub fn build(b: *std.Build) void {
    ...
    options.addOption([]const u8, "static_package", "static_profile");
    ...
    const tests = b.addTest(.{ .root_module = static_profile_mod });
    ...
    const examples = [_]struct { name: []const u8, path: []const u8 }{
        .{
            .name = "static_profile_chrome_trace_basic",
            .path = "examples/chrome_trace_basic.zig",
        },
        .{
            .name = "static_profile_counter_basic",
            .path = "examples/counter_basic.zig",
        },
        .{
            .name = "static_profile_hooks_emit_basic",
            .path = "examples/hooks_emit_basic.zig",
        },
    };
    for (examples) |ex| {
