...
pub fn build(b: *std.Build) void {
    ...
    options.addOption([]const u8, "static_package", "static_math");
    ...
    const tests = b.addTest(.{ .root_module = static_math_mod });
    ...
    const examples = [_]struct { name: []const u8, path: []const u8 }{
        .{ .name = "static_math_basic", .path = "examples/math_basic.zig" },
        .{ .name = "static_math_transform_roundtrip", .path = "examples/transform_roundtrip.zig" },
        .{ .name = "static_math_camera_look_at_conventions", .path = "examples/camera_look_at_conventions.zig" },
        .{ .name = "static_math_mat3_2d_transform", .path = "examples/mat3_2d_transform.zig" },
    };
    for (examples) |ex| {
        const exe = b.addExecutable(.{
            ...
            .root_module = b.createModule(.{
                ...
                .optimize = optimize,
                .imports = &.{
                    .{ .name = "static_math", .module = static_math_mod },
                },
            }),
        });
